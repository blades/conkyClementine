...
#  Author: Kaivalagi
# Created: 01/08/2010
#  Updated for Python 3 by: blades
# Updated: 02/05/2018
...
class ClementineInfo:
    ...
    def __init__(self, options):
        ...
        self.logInfo("Initialising ClementineInfo object")
        
    def testDBus(self, bus, interface):
        obj = bus.get_object('org.freedesktop.DBus', '/org/freedesktop/DBus')
        dbus_iface = dbus.Interface(obj, 'org.freedesktop.DBus')
        avail = dbus_iface.ListNames()
        return dbus.String(interface) in avail
            ...
            if self.musicData == None:
                ...
                if self.testDBus(bus, 'org.mpris.clementine'):
                    ...
                    try:
                        ...
                        props = remote_player.GetMetadata()
                        ...
                        if "arturl" in props:
                            coverart = os.path.expanduser(urllib.parse.unquote_plus(str(props["arturl"])).replace("file://",""))
                        ...
                        if self.options.secondsoutput == True:
                            ...
                            length = str(int(length_seconds/60)).rjust(1,"0")+":"+str(int(length_seconds%60)).rjust(2,"0")
